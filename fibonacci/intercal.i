PLEASE NOTE This initializes the arrays used by the library
(1) PLEASE DO (3990) NEXT

PLEASE NOTE Number input into .1
PLEASE DO (3080) NEXT

PLEASE NOTE .10 is how many loops left, :11 is previous, :12 is current
...
PLEASE NOTE Main Fibonacci math. 1500 is addition of two 32-bit numbers
DO :1 <- :11
DO :2 <- :12
PLEASE DO (1500) NEXT
DO :11 <- :2
...
PLEASE NOTE Decrementing the loop counter and restarting the loop
DO .1 <- .10
DO .2 <- #1
PLEASE DO (1010) NEXT
DO .10 <- .3
...
PLEASE NOTE The rest of this file consists of a numeric I/O library.
